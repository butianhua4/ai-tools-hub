...
Generated at: 2026-06-16T07:02:10.072Z
...
| publish pack includes human decision and risk context | FAIL | content/blog/tools-not-to-buy-first.mdx, content/blog/vector-database-selection-for-rag-guide.mdx, content/blog/vercel-ai-gateway-multi-provider-guide.mdx |
...
| traffic claim guard found no unsupported claims | PASS | filesScanned=220, unsafeClaims=0, watchMentions=9736 |
...
| internal link opportunity audit is read-only and covers expansion candidates | FAIL | public=500, expansion=19, broadFirst=8, candidates=25 |
...
| internal link sprint board covers all linkable candidates | PASS | items=25, waves=7, public=500, suggestions=75 |
| internal link sprint board keeps link edits manual and publish-safe | FAIL | ready=3, actions=200, unsafe=22, publishConfirm=0 |
| source target health audit is read-only and covers review source scopes | FAIL | broadFirst=8, current=3, publicGap=8, next=15, files=24 |
| source target health audit has reachable URLs for every covered review file | PASS | checked=38, ok=37, failed=1, missingTargets=0, filesWithoutReachable=0 |
| source target remediation pack is read-only and mirrors source health counts | PASS | items=18, failed=1/1, redirected=17/17 |
| source target remediation pack keeps every source fix human-gated | PASS | ready=18, unsafe=0, gated=18, replacementCandidates=8 |
| source replacement decision pack is read-only and mirrors remediation counts | PASS | decisions=110, remediation=18, failed=1/1, redirected=109/17 |
| source replacement decision pack keeps file-level decisions human-gated | PASS | unsafe=0, gated=110, recommended=1, official=1 |
| review action board is read-only and covers active review queues | PASS | tasks=11, wave=3, publicGap=8 |
| review action board tasks are ready and preserve command boundaries | FAIL | ready=2, unsafe=9 |
| review portfolio board deduplicates all review packs | PASS | sourceCandidates=17, uniqueItems=16, duplicates=1, multiSource=1 |
| review portfolio board keeps unique candidates safe and human-gated | FAIL | ready=8, safe=8, sources=16, commands=16 |
| autopilot review queue is read-only and covers portfolio candidates | PASS | items=16, next=8, sources=16 |
| autopilot review queue keeps assignments safe and human-gated | FAIL | ready=8, blocked=0, safe=8, unsafe=8 |
| autopilot approval packet packages the top safe assignments | FAIL | items=3, ready=3, sources=3, queries=3 |
...
| autopilot internal link brief covers approval packet | FAIL | items=3, public=500, unsafe=2 |
| autopilot internal link brief provides public link suggestions | FAIL | suggestions=1, missingCurrentPublicLink=2, alreadyLinked=1 |
...
| human approval repair queue covers decision matrix | FAIL | files=3, tasks=56, minimum=3/16, blockers=0/0, unsafe=0 |
| human approval repair queue stays manual and non-publishing | PASS | humanGated=56/56, minimum=3/16, publishConfirm=0 |
...
| human approval repair progress covers repair route | FAIL | files=3, categories=18, open=7, blocked=4 |
| human approval repair progress stays manual and non-publishing | FAIL | readyAfterRepair=0, open=7, evidenceReady=3, publishConfirm=0 |
...
| autopilot queued playbook brief has complete human-gated actions | FAIL | ready=7, search=7, source=7, links=1 |
...
| autopilot broad wave optimization has actionable SEO and approval guidance | PASS | ready=7, checklists=7, links=1 |
| autopilot broad wave remediation pack covers optimization items | PASS | items=7, waves=3, readyWaves=3, unsafe=0 |
| autopilot broad wave remediation pack has human-gated fixes | PASS | ready=7, search=7, source=7, linkPlan=7, missingSpecificLinks=6 |
...
| human approval execution queue is read-only and covers approval wave | PASS | items=6, immediate=3, backlog=3, promptLanes=4, projected=503 |
| human approval execution queue stays human-gated and excludes publish confirm | PASS | ready=6, sourceDecisions=5, seoWarnings=1, promptLanes=4, publishConfirm=0 |
| human approval clearance pack is read-only and covers the full approval queue | PASS | items=6, immediate=3, backlog=3, failedSources=0, seo=1 |
| human approval clearance pack keeps all work human-gated and action-ready | PASS | ready=6, actions=40, sourceDecisions=0, copydesk=2, publishConfirm=0 |
| review optimization brief is read-only and covers ready action-board tasks | PASS | briefs=2, ready=2, unsafeCommands=0 |
| review optimization brief has actionable copydesk guidance | FAIL | withAction=2, missingPublicLinkItems=1, exactQueryWeak=2 |
| search snippet readiness audit is read-only and covers public plus expansion items | FAIL | public=500, expansion=19, scoped=503 |
| search snippet readiness audit has no blocking Wave 1 issues | PASS | blocking=0, wave=3, waveBlocking=0, warnings=200 |
| structured data readiness audit is read-only and covers public plus expansion items | FAIL | public=500, expansion=19, scoped=503 |
| structured data readiness audit has JSON-LD previews and no blocking Wave 1 issues | PASS | blocking=0, previews=503, wave=3, waveBlocking=0, warnings=92 |
| SEO warning remediation pack is read-only and mirrors snippet/schema warnings | PASS | items=256, snippet=200/200, schema=92/92 |
| SEO warning remediation pack keeps every SEO fix human-gated | PASS | ready=256, public=255, draft=1, gated=256 |
...
| search query match audit is read-only and covers query plan | PASS | items=12, ready=12, warnings=11 |
...
| search demand intake packages sources, formats, and manual review boundaries | FAIL | queries=81, sources=29, formats=32, queueMatches=0 |
...
| search demand publication bridge confirms manual approval readiness | PASS | approvalReady=11, snippet=11, schema=11, source=11, links=2 |
...
| mass AI search action matrix keeps prompt and deployment work human-gated | FAIL | ready=6, deploy=0, prompt=0, unsafe=2 |
| popular AI prompt playbook is read-only and covers broad prompt demand | PASS | items=10, work=3, agent=3, memory=1, sources=12 |
| popular AI prompt playbook keeps templates human-gated and publish-safe | FAIL | ready=3, templates=50, queries=143, uniqueFiles=20, publishConfirm=0 |
...
| popular prompt approval bridge keeps next candidates human-gated and publish-safe | FAIL | items=13, ready=7, templates=65, uniqueFiles=7, publishConfirm=0 |
| popular prompt sprint board covers every broad prompt lane | PASS | items=10, queries=123, buckets=5, waves=5 |
| popular prompt sprint board keeps prompt expansion manual and publish-safe | FAIL | ready=3, actions=90, nextFiles=7, publishConfirm=0 |
...
| public coverage gap preflight is read-only and covers gap plan items | FAIL | items=8, planItems=0, broadFirst=8, uniqueFiles=8 |
| public coverage gap preflight has no blocking publish-readiness issues | FAIL | blocking=8, ready=0, structured=8, seedMatches=7, warnings=7 |
| public coverage gap decision pack is read-only and covers preflight items | FAIL | items=8, ready=0, waves=4 |
| public coverage gap decision pack has human review actions and command boundaries | FAIL | blocking=8, unsafe=8, commandBoundary=8, optimizations=8 |
...
| public refresh sprint board covers public refresh pack | FAIL | items=500, public=500, waves=167, mojibakePublic=9, seo=255, shortDescriptions=457 |
| public refresh sprint board keeps public edits manual and publish-confirm-free | PASS | ready=500, actions=5070, unsafe=0, publishConfirm=0 |
| public search refresh session pack covers public sprint waves | PASS | sessions=167, files=500, actions=5070, ready=500 |
...
| manual review workbench includes SEO warning remediation | PASS | workbenchSeo=256, remediation=256, unsafe=0 |
| next batch approval route matches manual review workbench | PASS | batch=1, items=3, workbenchItems=3, public=500, publishable=0 |
| next batch approval route is human-gated and action-ready | PASS | ready=3, actions=37, sourcePack=3, queryCoverage=3, warnings=8, publishConfirm=0 |
| next batch route remediation pack covers route warnings | PASS | batch=1, items=3, warningItems=3, routeWarnings=8, actions=33 |
| next batch route remediation pack stays safe and publish-confirm-free | PASS | ready=3, unsafe=0, publishConfirm=0, clearanceGaps=1, copydeskGaps=2, queryWarnings=3, seoWarnings=1 |

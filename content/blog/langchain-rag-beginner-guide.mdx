...
这篇是草稿，正式发布前需要核对 LangChain 最新文档和包名。更通用的知识库流程可以看 [RAG 知识库怎么搭](/blog/rag-knowledge-base-beginner-guide)，向量库选择可以看 [向量数据库怎么选](/blog/qdrant-vector-database-beginner-guide)。

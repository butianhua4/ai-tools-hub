...
secondaryKeywords:
  ...
  - "面试题提示词"
  - "培训材料 AI"
sourceNotes: "已于 2026-06-14 按 OpenAI 官方 Prompt Engineering、Prompt guidance、Text generation、Safety best practices、EEOC AI 相关资料和 U.S. Department of Labor AI hiring framework 核对提示词结构、输出约束、公平复核和人工决策边界；结合 JD、简历初筛、面试题和培训材料流程整理。正式公开前仍需人工核对招聘公平、隐私保护、歧视风险和当地劳动法规。"

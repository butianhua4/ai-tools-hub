...
这篇是草稿，正式发布前需要核对 FastGPT 最新官方文档。通用 RAG 入门可以看 [RAG 知识库怎么搭](/blog/rag-knowledge-base-beginner-guide)，向量库基础可以看 [向量数据库怎么选](/blog/qdrant-vector-database-beginner-guide)。
